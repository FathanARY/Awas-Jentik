  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md rounded-2xl shadow-xl border bg-white/80 backdrop-blur-sm p-8" style={{ borderColor: "var(--color-outline-variant)" }}>
        ...
        <button onClick={() => signInWithGoogle()} className="w-full py-3 rounded-xl border border-slate-300 bg-white text-slate-700 font-bold text-sm hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
