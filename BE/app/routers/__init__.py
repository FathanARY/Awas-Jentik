...
from app.routers.grids_stats import router as grids_stats_router

routers = [laporan_router, predict_router, dashboard_router, auth_router, pcam_router, notif_router, mobilitas_router, model_info_router, grids_stats_router]
